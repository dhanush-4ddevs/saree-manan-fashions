...
export function VoucherCard({ voucher, onView, onPrint, onTrack, onEdit }: VoucherCardProps) {
  ...
  const dispatchEvent = voucher.events.find((e: { event_type: string; }) => e.event_type === 'dispatch');
    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-100 overflow-hidden">
      <div className="p-5">
        ...
        <div className="flex items-center mb-2">
          ...
          <p className="text-gray-700">{voucher.item_details.item_name} - {formatIndianQuantity(voucher.item_details.initial_quantity)} pieces</p>
        </div>
