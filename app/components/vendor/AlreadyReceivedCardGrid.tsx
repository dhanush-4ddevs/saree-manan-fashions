...
interface AlreadyReceivedCardGridProps {
  items: ReceiveItem[];
...
export function AlreadyReceivedCardGrid({
  items,
  onEdit,
  onSave,
  onCancel,
    ...
    <div className="space-y-4">
      ...
      <div className="bg-green-50 p-4 border border-green-200 rounded-lg">
              ...
              {showSortMenu && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg border z-20 p-3">
                  ...
                  <div className="flex gap-2 mt-2">
                    <button onClick={() => onSort(sortField)} className={`flex-1 p-2 rounded-md ${sortDirection === 'asc' ? 'bg-green-500 text-white' : 'bg-gray-100'}`}>
                      <SortAsc className="h-4 w-4 mx-auto" />
                    </button>
                    <button onClick={() => onSort(sortField)} className={`flex-1 p-2 rounded-md ${sortDirection === 'desc' ? 'bg-green-500 text-white' : 'bg-gray-100'}`}>
        ...
        <div className="mt-4 text-sm text-gray-600">
          Showing {filteredItems.length} of {items.length} already received vouchers.
        </div>
      </div>
      ...
      {filteredItems.length === 0 ? (
        <div className="text-center text-gray-500 py-8">
          <div className="flex flex-col items-center justify-center">
            ...
            <h3 className="text-xl font-medium text-gray-600 mb-2">No already received vouchers found</h3>
