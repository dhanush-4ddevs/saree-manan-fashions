...
import { FileText, Save, AlertTriangle, X, Edit, CheckCircle } from 'lucide-react';
...
interface AlreadyReceivedCardProps {
  item: ReceiveItem;
  isEditing: boolean;
  currentData: any;
      ...
      <div className="p-4 space-y-3">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm font-medium text-green-800">Already Received</span>
          </div>
          {item.isForwarded && (
